...
CLI tools that provide a terminal interface to LLM APIs.
...
- **LLM CLI Frontend**: The CLI interface part, separate from the underlying LLM model
- These tools are also called "terminal agents" or "agentic CLI tools" in the industry
